...
short int main_menu()
{
	...
	cout << "Нижеперечисленные задания не завершены.\n";
...
void Task9() 
{
	...
	int decreaser;
	cout << "На какое значение необходимо уменьшить каждый четный элемент?	";
	cin >> decreaser;
	int randomized = 1 + rand() % 5;
	cout << "Случайный делитель для нечетных чисел: " << randomized << endl;
